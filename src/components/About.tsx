        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="order-2 lg:order-1">
            ...
            <p className="text-lg mb-6 leading-relaxed">
              Founded in 2010, Magic Cuts has established itself as one of South Africa's premier barbershops, blending traditional techniques with modern styles to deliver exceptional grooming experiences.
            </p>
