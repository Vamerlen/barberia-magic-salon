  ...
  const testimonials: Testimonial[] = [
    {
      ...
      quote: "Magic Cuts is my go-to place for a perfect cut. The attention to detail and the professional service make every visit a great experience.",
      rating: 5,
    ...
    },
    {
      ...
      quote: "As someone who's always in the public eye, having a reliable barber is essential. Magic Cuts delivers every time with style and professionalism.",
      rating: 5,
